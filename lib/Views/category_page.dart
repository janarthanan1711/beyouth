            ...
            bottom: TabBar(
                ...
                indicator: BoxDecoration(
                    gradient: LinearGradient(
                        colors: [
                          ColorResource.colorYellow,
                          ColorResource.iconBackgroundColor
                        ]),
                            ...
                            leading: Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(image: AssetImage(
                                      categoryList[index].categoryImages),
                                      fit: BoxFit.fill)
                              ),
                            ),
                            title: Padding(
                              padding: const EdgeInsets.only(left: 30),
                              child: Text(categoryList[index].categoryTitles,
                                style: TextStyle(fontWeight: FontWeight.bold,
                                  color: Mytheme.isDark == true ? ColorResource
                                      .colorYellow : Colors.black,
                                  fontSize: 25,),
                              ),
                            ),
                          ),
                        ...
                        child: Center(
                          child: ListTile(
                            leading: Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(image: AssetImage(
                                      womenCategoryList[index].categoryImages),
                                      fit: BoxFit.fill)
                              ),
                            ),
                            title: Padding(
                              padding: const EdgeInsets.only(left: 30),
                              child: Text(
                                womenCategoryList[index].categoryTitles,
                                style: TextStyle(fontWeight: FontWeight.bold,
                                  color: Mytheme.isDark == true ? ColorResource
                                      .colorYellow : Colors.black,
                                  fontSize: 25,),
